package dev.himbra.customer.Controller;

import dev.himbra.customer.dtos.CustomerReq;
import dev.himbra.customer.dtos.CustomerRes;
import dev.himbra.customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<String> createCustomer(
            @RequestBody @Valid CustomerReq request
    ) {
    ...
    public ResponseEntity<CustomerRes> findById(
            @PathVariable("customer-id") String customerId
    ) {
